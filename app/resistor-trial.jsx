  ...
  render() {
    return (
      <svg height="170.0998" width="526.99999"   viewBox="0 0 526.99999 170.0998">
        ...
        <Band1
          bandColor={this.props.bandColors.band1Color} resistorDecoderInfo={this.props.resistorDecoderInfo}
          selectedBandNumber={this.props.selectedBandNumber}/>
        <Band2
          bandColor={this.props.bandColors.band1Color}/>
        <Band3
          bandColor={this.props.bandColors.band1Color}/>
        <Band4
          visibility={(this.props.selectedBandNumber == '4') ? 'hidden' : 'visible'}
          bandColor={this.props.bandColors.band1Color}/>
        <Band5
          visibility={((this.props.selectedBandNumber == '4') || (this.props.selectedBandNumber == '5')) ? 'hidden' : 'visible'}
          bandColor={this.props.bandColors.band1Color}/>
        <Band6
          bandColor={this.props.bandColors.band1Color}/>
        <use  xlinkHref="#help" />
