    ...
    return (
      <div className="container">
        ...
        {this.props.bandClicked == ''
          ? ''
          : <BandColorMenu resistorDecoderInfo={this.props.resistorDecoderInfo} selectedBandNumber={this.props.selectedBandNumber} bandClicked={this.props.bandClicked} onColorClick={this.props.onColorClick}
          bandColors={this.props.bandColors}/>}
          <p>{this.props.bandColors.band1} printed bt resistor trial render</p>
